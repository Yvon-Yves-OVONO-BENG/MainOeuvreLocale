...
#[Route('/admin/chat')]
class AdminChatSettingsController extends AbstractController
{
    #[Route('/parametres', name: 'admin_chat_settings', methods: ['GET'])]
    ...
    #[Route('/parametres/enregistrer', name: 'admin_chat_settings_save', methods: ['POST'])]
    public function save(Request $request, EntityManagerInterface $em): Response
    {
        ...
        return $this->redirectToRoute('admin_chat_settings');
    }

    #[Route('/tester', name: 'admin_chat_test', methods: ['POST'])]
